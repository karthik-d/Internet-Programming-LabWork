...
//3. Open a Connection
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/test_db?autoReconnect=true&useSSL=false",user,password);
...
String s = "select * from coffeedetails where color = \'" + color + "\'";
