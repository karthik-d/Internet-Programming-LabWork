...
public class User
{
	...
	public UserDetails validateUser(String email, String password) throws Exception{
		...
		String query = "SELECT email, name, password, role FROM users WHERE email='" + email + "'";
		/* Parse result */
		...
		if(rs.next()){
			...
			if(password.equals(rs.getString(3))){
				...
				ret_user = new UserDetails(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4));
			}
		}
		st.close();
		con.close();
